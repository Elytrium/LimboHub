...
public class SpawnEntity implements MinecraftPacket {
  ...
  public SpawnEntity(int id, UUID uuid, Function<ProtocolVersion, Integer> type, double positionX,
                     double positionY, double positionZ, float pitch, float yaw, float headYaw, int data) {
    this.id = id;
    this.uuid = uuid;
    this.type = type;
